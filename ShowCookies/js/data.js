...
var preferences_template = {
    ...
    // Show the BlockAndDeleteAll button in the popup window. 
    "showFlagAndDeleteAll": {
        "default_value": true
    },
    // Show an option to open ShowCookie as a separate tab in the context menu
    "showContextMenu": {
        "default_value": true
    },
    ...
    // If true, a custom locale is used rather than the default set by the browser
    "useCustomLocale": {
        "default_value": false
    },
...
window.addEventListener("storage", function (event) {
    try {
        ...
        console.error("updateCallback'te arama başarısız oldu.");
