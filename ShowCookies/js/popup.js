...
function createAccordionList(cks, callback, callbackArguments) {
    ...
    for (var i = 0; i < cks.length; i++) {
        ...
        if(currentC.name=="_ga")
           $(".purpose", cookie).val("oturum");
        else if(currentC.name=="_gid")
           $(".purpose", cookie).val("oturum");
        else if(currentC.name.includes("TOKEN"))
           $(".purpose", cookie).val("islevsellik");
        else if(currentC.name.includes("token"))
           $(".purpose", cookie).val("islevsellik");
        else if(currentC.name.includes("_utma"))
           $(".purpose", cookie).val("oturum");
        else if(currentC.name.includes("_utmc"))
           $(".purpose", cookie).val("oturum");
        else if(currentC.name.includes("İd"))
           $(".purpose", cookie).val("reklam");
        else if(currentC.name.includes("IDE"))
           $(".purpose", cookie).val("reklam");
        else if(currentC.name.includes("_gcl_gb"))
           $(".purpose", cookie).val("analitik,reklam");
        else if(currentC.name.includes("_gcl_au"))
           $(".purpose", cookie).val("analitik,reklam");
        else if(currentC.name.includes("gpi"))
           $(".purpose", cookie).val("reklam");
        else
        $(".purpose", cookie).val("belirsiz");
