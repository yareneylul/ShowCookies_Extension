...
(function (wind, $, undef) {
    ...
    /**
     * Daha eski jQuery kitaplıklarıyla geriye dönük uyumluluk için
     *Bir seferde bir şey. Ayrıca, bu işlev ad alanımızı şuna ekler:
     * Küçültülmüş kodu küçülten tek bir tutarlı konumdaki olaylar.
     *
     * Olaylar nesnesindeki özellikler olayların isimleridir.
     * eklememiz gereken. Boşlukla ayrılmış bir liste olabilir.
     * Ad alanı otomatik olarak eklenecektir.
     * 
     * @param {jQuery} $el
    ...
    /**
     * üzerine gelme, etkin, odaklanma ve bulanıklaştırma kullanıcı arabirimi güncellemelerini bağla
     *
